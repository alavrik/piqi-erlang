...
parse_field(X) ->
    ...
    {_Json_omit_missing, R8} = piqirun:parse_optional_field(201807079, fun parse_bool/1, R7),
    {_Getopt_letter, R9} = piqirun:parse_optional_field(215188758, fun parse_word/1, R8),
    {_Type, R10} = piqirun:parse_optional_field(218690234, fun parse_type/1, R9),
    {_Piq_format, R11} = piqirun:parse_optional_field(296833484, fun parse_piq_format/1, R10),
    {_Getopt_doc, R12} = piqirun:parse_optional_field(442330184, fun parse_string/1, R11),
    {_Default, R13} = piqirun:parse_optional_field(465819841, fun parse_piqi_piqi_any/1, R12),
    {_Json_name, R14} = piqirun:parse_optional_field(515275216, fun parse_string/1, R13),
    piqirun:check_unparsed_fields(R14),
    #field{
        code = _Code,
        erlang_name = _Erlang_name,
...
[<<226,202,230,52,4,112,105,113,105,160,148,209,72,129,248,174,104,154,197,
   ...
   238,191,4,6,114,101,99,111,114,100,218,244,134,182,12,200,5,138,233,142,
   251,14,193,5,210,203,242,36,29,232,146,150,113,150,201,251,143,1,152,182,
   ...
   103,210,203,242,36,52,232,146,150,113,206,211,186,192,1,152,182,154,152,4,
   160,223,186,243,1,218,164,238,191,4,17,106,115,111,110,45,111,109,105,116,
   45,109,105,115,115,105,110,103,210,171,158,194,6,4,98,111,111,108,210,203,
   242,36,48,232,146,150,113,172,148,156,205,1,152,182,154,152,4,160,223,186,
   243,1,218,164,238,191,4,13,103,101,116,111,112,116,45,108,101,116,116,101,
   114,210,171,158,194,6,4,119,111,114,100,210,203,242,36,47,232,146,150,113,
   144,177,235,165,3,152,182,154,152,4,160,223,186,243,1,218,164,238,191,4,10,
   103,101,116,111,112,116,45,100,111,99,210,171,158,194,6,6,115,116,114,105,
   ...
   109,101,210,171,158,194,6,6,115,116,114,105,110,103,218,164,238,191,4,5,
   102,105,101,108,100,218,244,134,182,12,109,138,176,205,197,1,103,218,164,
   238,191,4,10,102,105,101,108,100,45,109,111,100,101,170,183,218,222,5,23,
   232,146,150,113,190,197,148,166,2,218,164,238,191,4,8,114,101,113,117,105,
   114,101,100,170,183,218,222,5,23,232,146,150,113,192,190,245,230,3,218,164,
   238,191,4,8,111,112,116,105,111,110,97,108,170,183,218,222,5,23,232,146,
   150,113,244,241,173,133,2,218,164,238,191,4,8,114,101,112,101,97,116,101,
   100,218,244,134,182,12,175,2,138,233,142,251,14,168,2,210,203,242,36,29,
   232,146,150,113,150,201,251,143,1,152,182,154,152,4,223,162,138,147,1,210,
   171,158,194,6,4,110,97,109,101,210,203,242,36,31,232,146,150,113,234,205,
   214,183,1,152,182,154,152,4,250,248,214,130,1,210,171,158,194,6,6,111,112,
   116,105,111,110,210,203,242,36,49,232,146,150,113,154,143,243,85,152,182,
   154,152,4,160,223,186,243,1,218,164,238,191,4,13,112,114,111,116,111,98,
   117,102,45,110,97,109,101,210,171,158,194,6,6,115,116,114,105,110,103,210,
   ...
   46,232,146,150,113,160,231,179,235,3,152,182,154,152,4,160,223,186,243,1,
   218,164,238,191,4,9,106,115,111,110,45,110,97,109,101,210,171,158,194,6,6,
   115,116,114,105,110,103,210,203,242,36,47,232,146,150,113,250,232,143,30,
   ...
   164,238,191,4,7,118,97,114,105,97,110,116,218,244,134,182,12,216,3,138,233,
   142,251,14,209,3,210,203,242,36,29,232,146,150,113,150,201,251,143,1,152,
   182,154,152,4,160,223,186,243,1,210,171,158,194,6,4,110,97,109,101,210,203,
